...
public class FastSpawnL2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        InvokeRepeating("spawn_random", .5f, .5f);
    }
    ...
    void spawn_random()
    {
        ...
        GameObject createObject = Instantiate(spawnables[Random.Range(0, spawnables.Count-1)], v3Pos, qRotation);
